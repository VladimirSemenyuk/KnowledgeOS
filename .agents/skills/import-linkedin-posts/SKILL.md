...
description: Импорт опубликованных LinkedIn-постов из открытой страницы LinkedIn/Analytics в Posts/published, обновление vault без дублей и сбор аналитики только за последний месяц.
---
...
- аналитику постов за последний месяц;
...
- `Последние 28 дней`, если это ближайший доступный preset;
...
- Reactions: 0
- Comments: 0
- Source: LinkedIn Creator Analytics
```
