...
source_version: 2025
source_file: "[[Frameworks/sources/ai-transformation/google_cloud_roi_of_ai_2025.pdf|google_cloud_roi_of_ai_2025.pdf]]"
...
- [[Frameworks/models/ai-native-organization|AI-native organization]] строится не вокруг "доступа к модели", а вокруг управляемых процессов с поддержкой AI;
- agentic AI требует [[Frameworks/models/organizational-operating-model|организационной операционной модели]], а не только бюджета на инструменты;
...
Это совпадает с рамкой [[Frameworks/models/architecture-of-manageability|architecture of manageability]]:
...
- PDF: `/Users/vladimir/Obsidian/KnowledgeOS/Frameworks/sources/ai-transformation/google_cloud_roi_of_ai_2025.pdf`
