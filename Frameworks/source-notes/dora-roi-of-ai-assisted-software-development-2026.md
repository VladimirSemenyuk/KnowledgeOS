...
source_file: "[[Frameworks/sources/ai-transformation/dora-roi-of-ai-assisted-software-development-2026.pdf|dora-roi-of-ai-assisted-software-development-2026.pdf]]"
...
- [[Frameworks/models/architecture-of-manageability|architecture of manageability]] становится условием AI ROI: платформы, данные, контрольные точки, метрики и зоны ответственности важнее самой модели.
...
- есть качественный [[Frameworks/models/internal-developer-platform|Internal Developer Platform]];
...
> Разработку с поддержкой AI нужно внедрять как изменение [[Frameworks/models/organizational-operating-model|организационной операционной модели]], а не как закупку инструментов для разработчиков.
...
Это хорошо ложится на рамку [[Frameworks/models/decision-systems|систем принятия решений]]:
...
- PDF: [[Frameworks/sources/ai-transformation/dora-roi-of-ai-assisted-software-development-2026.pdf|dora-roi-of-ai-assisted-software-development-2026.pdf]]
- Локальный файл: `Frameworks/sources/ai-transformation/dora-roi-of-ai-assisted-software-development-2026.pdf`
